...
{
	//use only channel0
	DACA.CTRLB = DAC_CHSEL_SINGLE_gc | DAC_CH0TRIG_bm;		//single1 is channel1 single is channel0
...
void tcc0_init()
{
	...
	TCC0.PER = 63;//161;//80			;//20;//39;
	TCC0.CTRLA = TC_CLKSEL_DIV1_gc;//TC_CLKSEL_DIV2_gc;			//TC_CLKSEL_DIV8_gc;//TC_CLKSEL_DIV4_gc;
